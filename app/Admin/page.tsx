    ...
    <>
      ...
      <Container size="xl" py="xl">
        <Paper shadow="sm" radius="lg" withBorder p="xl" bg="text-light" style={{ borderColor: '#D1D1D1' }}>
          ...
          <ScrollArea>
            <Table verticalSpacing="md" min-Width={800}>
              ...
              <Table.Tbody>
                {DUMMY_DATA.map((item, index) => (
                  <Table.Tr key={index} style={{ borderBottom: '1px solid #eee' }}>
                    ...
                    {/* <Table.Td><Checkbox checked readOnly  /></Table.Td> */}
                    ...
                    <Table.Td>
                      <Group gap="xs">
                        <ActionIcon variant="transparent" color="black" onClick={() => router.push("/Admin/BrandDetails")}><IconEdit size={18} /></ActionIcon>
                        <ActionIcon variant="transparent" color="black"><IconTrash size={18} /></ActionIcon>
                      </Group>
                    </Table.Td>
                  </Table.Tr>
                ))}
