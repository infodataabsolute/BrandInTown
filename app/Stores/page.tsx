  ...
  return (
    <>
      ...
      <Container size="xl" py="xl" bg="#ffff">
        <Grid gutter="xl">
          ...
          <Grid.Col span={{ base: 12, md: 9 }}>
            <Stack gap="md" >
              ...
              {/* Brand List */}
              {BRANDS.map((brand) => (
                <Paper key={brand.name} withBorder p="sm" radius="md" shadow="sm">
                  <Grid gutter="lg" align="stretch">
                    <Grid.Col span={{ base: 12, sm: 4 }}>
                      <Image onClick={openStore} src={brand.img} radius="md" h={140} />
                    ...
                    <Grid.Col span={{ base: 12, sm: 8 }}>
                      <Stack gap="xs">
                        ...
                        <Group gap={4} mt={5}>
                          <IconMapPin size={18} color="#3f3b3b" />
                        ...
                        <Group justify="space-between" mt="sm">
                          {/* <Button 
                            ...
                            size="xs" 
                            radius="sm"
                            styles={{ root: { backgroundColor: 'primary', color: '#141414ff' }}}
                        >
                        ...
                        <Group justify="space-between">
                          <Group gap="xs">
                            <IconClock size={16} color="primary" />
                            <Text size="xs" fw={600}>11:00 AM - 08:00 PM</Text>
                          </Group>
                          <Group gap="xs">
                            <IconPhone size={16} color="primary" />
        ...
        <Modal opened={storeOpened} onClose={closeStore} size="90%" radius="md" bd={"1px red"}>
...
>
  Subscribe
          ...
          {/* Categories Tabs */}
          {/* <Tabs defaultValue="women" mt="xl" color="primary"  variant="pills" > */}
          ...
          >
            ...
            <Tabs.List justify="center">
              ...
              <Tabs.Tab value="jewellery" leftSection={<IconDiamond size={16} />}>
                Jewellery
              </Tabs.Tab>
              ...
              <Tabs.Tab value="appliances" leftSection={<IconWashMachine size={16} />}>
                Home Appliances
              </Tabs.Tab>
              ...
              <Tabs.Tab value="sports" leftSection={<IconBallBasketball size={16} />}>
                Sports
              </Tabs.Tab>
            </Tabs.List>
...
>
  Book Your Product
                ...
                <Group gap="sm">
                  <Badge color="primary" variant="filled" size="xs" circle />
                ...
                {[
                  ...
                  <Group key={idx} justify="space-between" wrap="nowrap" style={{ borderBottom: '1px solid #f0f0f0', paddingBottom: '10px' }}>
                    <Group>
                      ...
                      <Stack gap={0}>
                        <Text size="sm" fw={700} color="primary">{offer.deal}</Text>
                        <Text size="xs" color="dimmed">on Shirts and Trousers</Text>
                      </Stack>
                    </Group>
                    <Text size="xs" color="dimmed">Valid till <Text span fw={700} color="primary">{offer.date}</Text></Text>
                  </Group>
                ))}
              </Stack>
            </Grid.Col>
                  ...
                  {[1, 2, 3].map((i) => (
                    <Group key={i} mb="md" wrap="nowrap">
                      ...
                      <Stack gap={0} align="flex-end">
                        <Group gap={2}>
                          <IconMapPin size={12} color="primary" />
          ...
          <Button
            ...
            styles={{
              root: {
                ...
                borderColor: item === active ? 'primary' : 'var(--mantine-color-gray-3)',
                padding: '4px 12px'
              }
            }}
          >
