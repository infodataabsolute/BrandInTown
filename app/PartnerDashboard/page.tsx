...
import BrandHeader from '../Partner/page';
    ...
    <Container size="xl" py={40}>
      ...
      {active === 2 && (
        <Box>
          ...
          <ScrollArea>
            <Table verticalSpacing="md" style={{ borderCollapse: 'separate', borderSpacing: '1px  10px' }}>
              <Table.Thead>
...
<Modal
        ...
        size="lg"
        radius="md"
        withCloseButton={false} // Custom close button use karenge image jaisa
        padding="xl"
      >
        {/* Custom Close Button */}
        ...
        <Stack gap="md">
          <SimpleGrid cols={2} spacing="lg">
            ...
            <Select
              ...
              data={['Brand Offer', 'Seasonal Offer', 'Flash Sale']}
              required
            />
            ...
            <TextInput
              ...
              rightSection={<IconCalendar size={18} color="primary" />}
              required
            />
            <TextInput
              label="Validity Till"
          ...
          <Group align="flex-start" grow>
            <Stack gap="xs">
              <Text size="sm" fw={500}>Is Active*</Text>
              <Group>
                <Checkbox label="Yes" color="primary" defaultChecked />
              ...
              <Select
                label="City"
                placeholder="Jaipur"
                data={['Jaipur', 'Delhi', 'Mumbai']}
              />
            </Stack>

            <Stack gap="xs">
              <Text size="sm" fw={500}>Upload Offer Image*</Text>
              <UnstyledButton
                style={{
                  height: '100px',
          ...
          <Group justify="flex-end" mt="xl">
            <Button
              ...
              style={{ backgroundColor: 'primary', color: '#2D3142' }}
            >
              Add
            </Button>
          </Group>
