...
export default function AdminFlow() {
  ...
  return (
    <Container size="xl" py={40}>
      ...
      {/* --- ADD/EDIT OFFER MODAL (image_c06090.png) --- */}
      {/* <Modal 
        opened={opened} 
        onClose={close} 
        title={<Text fw={700} size="lg" c={themeStyles.darkBlue}>Offer Details</Text>}
        centered
        size="lg"
        radius="md"
        padding="xl"
      >
        <Stack gap="lg">
          <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="lg">
            <TextInput label="Offer Title *" placeholder="Naveen Sharma" styles={themeStyles.input} />
            <Select 
              label="Offer Type *" 
              placeholder="Brand Offer" 
              data={['Brand Offer', 'Store Offer', 'Card Offer']} 
              styles={themeStyles.input} 
            />
          </SimpleGrid>
          ...
          <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="lg">
            <TextInput 
              ...
              rightSection={<IconCalendar size={18} color={themeStyles.primary} />} 
              styles={themeStyles.input} 
            />
            <TextInput 
              label="Validity Till *" 
          ...
          <Grid align="flex-end">
            ...
            <Grid.Col span={{ base: 12, sm: 6 }}>
              <Text size="sm" fw={600} c={themeStyles.darkBlue} mb={5}>Upload Offer Image *</Text>
              <Box 
                style={{ 
              ...
              >
                <ActionIcon variant="filled" bg={themeStyles.primary} size="xl" radius="xl">
                  <IconCamera size={24} color="black" />
                </ActionIcon>
              </Box>
            </Grid.Col>
          </Grid>
          ...
          <Select 
            ...
            data={['Aman Puma', 'Happy Shoppy']} 
            styles={themeStyles.input} 
          />

          <Group justify="flex-end" mt="xl">
            <Button 
              bg={themeStyles.primary} 
              c="dark" 
              radius="md" 
              size="md" 
              px={40}
